...
def main():
  ...
  train_graphs, v_dim, a_dim, _ = make_graph(train_id, train_label, model_name=config['training']['embed_model'])
  logger.info("Processing Validation Data")
  val_graphs, _, _, _ = make_graph(val_id, val_label, model_name=config['training']['embed_model'])
